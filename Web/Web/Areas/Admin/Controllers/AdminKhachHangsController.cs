...
namespace Web.Areas.Admin.Controllers
{
    ...
    public class AdminKhachHangsController : Controller
    {
        ...
        public AdminKhachHangsController(DbDiDongContext context)
        {
            _context = context;
        }
        ...
        public IActionResult Index(int? page)
        {
            ...
            var pageSize = 20;
            var lsKhachHangs = _context.KhachHangs.AsNoTracking()
        ...
        public async Task<IActionResult> Create([Bind("MaKh,TenKh,DiaChi,Sdt,NgaySinh,TaiKhoan,MatKhau,Salt,TrangThai,Email")] KhachHang khachHang)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaKh,TenKh,DiaChi,Sdt,NgaySinh,TaiKhoan,MatKhau,Salt,TrangThai,Email")] KhachHang khachHang)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DbDiDongContext.KhachHangs'  is null.");
            }
            var khachHang = await _context.KhachHangs.FindAsync(id);
            if (khachHang != null)
            {
